...
from maml_rl.envs.IDM_Mobil.road.lane import LineType, StraightLane, SineLane
...
from maml_rl.envs.IDM_Mobil.road.objects import Obstacle
...
register(
    id='merge-v0',
    entry_point='IDM_Mobil.envs:MergeEnv',
)
