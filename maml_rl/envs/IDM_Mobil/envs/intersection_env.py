...
from maml_rl.envs.IDM_Mobil.envs.common.abstract import AbstractEnv, MultiAgentWrapper
from maml_rl.envs.IDM_Mobil.road.lane import LineType, StraightLane, CircularLane, AbstractLane
from maml_rl.envs.IDM_Mobil.road.regulation import RegulatedRoad
from maml_rl.envs.IDM_Mobil.road.road import RoadNetwork
...
register(
    id='intersection-v0',
    entry_point='IDM_Mobil.envs:IntersectionEnv',
)

register(
    id='intersection-multi-agent-v0',
    entry_point='IDM_Mobil.envs:MultiAgentIntersectionEnv',
)

register(
    id='intersection-multi-agent-v1',
    entry_point='IDM_Mobil.envs:TupleMultiAgentIntersectionEnv',
)
