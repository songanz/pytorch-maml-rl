...
class ActionType(object):
    ...
    def vehicle_class(self) -> Callable:
        ...
        Must return a subclass of :py:class:`IDM_Mobil.vehicle.kinematics.Vehicle`.
        """
        raise NotImplementedError
    ...
    def act(self, action: Action) -> None:
        ...
        vehicle is an instance of the specified :py:class:`IDM_Mobil.envs.common.action.ActionType.vehicle_class`.
