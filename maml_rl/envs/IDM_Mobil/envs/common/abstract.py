...
from maml_rl.envs.IDM_Mobil.envs.common.action import action_factory, Action, DiscreteMetaAction, ActionType
from maml_rl.envs.IDM_Mobil.envs.common.observation import observation_factory, ObservationType
from maml_rl.envs.IDM_Mobil.envs.common.finite_mdp import finite_mdp
from maml_rl.envs.IDM_Mobil.envs.common.graphics import EnvViewer
from maml_rl.envs.IDM_Mobil.vehicle.behavior import IDMVehicle, LinearVehicle
from maml_rl.envs.IDM_Mobil.vehicle.controller import MDPVehicle
from maml_rl.envs.IDM_Mobil.vehicle.kinematics import Vehicle
...
class AbstractEnv(gym.Env):
    ...
    automatic_rendering_callback = None
    ...
    def default_config(cls) -> dict:
        ...
        return {
            ...
            "other_vehicles_type": "maml_rl.envs.IDM_Mobil.vehicle.behavior.IDMVehicle",
            "screen_width": 600,  # [px]
    ...
    def change_vehicles(self, vehicle_class_path: str) -> 'AbstractEnv':
        ...
        :param vehicle_class_path: The path of the class of behavior for other vehicles
                             Example: "IDM_Mobil.vehicle.behavior.IDMVehicle"
